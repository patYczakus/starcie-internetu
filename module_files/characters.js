export const charaList = {
    ...
    lunatone: {
        battle: [
            ...
            { atk: 100, name: "Moonblast", points: 30 },
        ],
        description: {
        ...
        sp: {
            name: "Laser z ziemi",
            description: {
                pl: "lunatone atakuje przeciwnika po 3 sekundach od użycia, jednocześnie zwiększając jego HP o 7% i ataki o 4%.",
    ...
    gabrysiaSotoła: {
        battle: [
            ...
            {
                atk: 200,
                name: "Niebiańskie ognie z wydechu wyścigowego",
                points: 40,
            },
        ],
        description: {
    ...
    snackowyAdmin: {
        battle: [
            ...
            { atk: 230, name: "Kotołap", points: 65 },
        ],
        description: {
