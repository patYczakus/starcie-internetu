const articles = [
    {
        ...
        img: "default",
        article: [
            `Te głoszenia tracą swoją moc na rzecz <a href="https://discord.gg/7S3P2DUwAm" target="_blank">serwera support</a>. Tam też można skontaktować się z działem wsparcia.<br />Tym razem usunąłem wszystkie dane kont, a nie je podmieniłem kosztem innej bazy danych, także każdy zaczyna od zera na start!`,
